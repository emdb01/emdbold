    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Unique Recruiters</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="uniquerecruiters.php?Refine=0&serterm=<?php echo $_GET['serterm']; ?>&q=<?php echo $_GET['q']; ?>"  method="post">
                                <?php if ($_GET['serterm'] != '') { ?>
                                        ...
                                        <tbody>
                                          ...
                                          $nameSearch = str_replace("EMDB", "", $nameSearch);
                                            if (strlen($nameSearch) > 1) {
                                                    $query_pag_data = "SELECT  DISTINCT emdbid,searchPerson,createdDate,recruiterId from `search` where recruiterId !=0   and emdbid LIKE '%{$nameSearch}%' order by id desc";
                                            } else {
                                                $query_pag_data = "SELECT  DISTINCT emdbid,searchPerson,createdDate,recruiterId FROM `search` where recruiterId !=0 order by id desc";
                                            }

                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php if ($_GET['id'] == '1') { ?>
                                <form action="notverifyjs.php" name="checkavail" id="checkavail"  method="post"  >
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="notverifyjs.php?Refine=0&serterm=<?php echo $_GET['serterm']; ?>&q=<?php echo $_GET['q']; ?>"  method="post">
...
//                       echo $_POST['q'];
        ...
        $(document).ready(function () {
            ...
            var dataTable = $('#employee-grid').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "notverifedgrid.php", // json datasource

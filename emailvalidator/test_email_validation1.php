...
?><html>
    <head>
        <title>Test for Manuel E-mail validation class</title>
    </head>
    <body>
        <h1 align="center">Test for Manuel E-mail validation class</h1>
        <hr>
        <?php
...
//        $validator->email_domains_white_list_file = 'emaildomainswhitelist.csv';
        ...
        $csv_file = "blacklist2.csv"; // Name of your CSV file

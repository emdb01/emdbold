    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Idolize Job Seekers</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php if ($_GET['id'] == '1') { ?>
                                <form action="idolizeprofiles.php" name="checkavail" id="checkavail"  method="post"  >
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="idolizeprofiles.php?Refine=0&serterm=<?php echo $_GET['serterm']; ?>&q=<?php echo $_GET['q']; ?>"  method="post">
...
//                       echo $_POST['q'];
        ...
        $(document).ready(function () {
            ...
            var dataTable = $('#employee-grid').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "employee-grid-idolizedata.php", // json datasource

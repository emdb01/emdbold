                ...
                if ($_POST['filepath'] != '') {
                            ...
                            <?php if ($name != '') { ?>
                                ...
                                if ($ext == '') {
                                    ...
                                    if (strlen($pos) != 0) {
                                        ...
                                        ?>
                                        <div class="col-lg-3">
                                            <div class="panel panel-primary text-center  " id="bgstyle<?php echo $i; ?>" style="padding:10px;border: 0px solid #5bc0de !important;margin: 0px 10px 0px;margin-bottom:20px;webkit-box-shadow: 0 1px 1px 0 rgba(0,0,0,.2);
                                                 box-shadow: 0 1px 1px 0 rgba(0,0,0,.2);" onClick="myStyle('<?php echo urldecode(ltrim($fileInfo['url_path'], "?dir=")); ?>',<?php echo $i; ?>, '<?php echo $name; ?>');">
                        ...
                        foreach ($dirArray as $name => $fileInfo):
                            ...
                            if ($name != '') {
                                if ($ext != '') {
                                    ...
                                    <div class="col-lg-3"  >
                                        <div id="bgstyle<?php echo $i; ?>" class="panel panel-primary text-center no-boder "  style="" onClick="myStyle('<?php echo urldecode($fileInfo['url_path']); ?>',<?php echo $i; ?>, '<?php echo $name; ?>');">
                    ...
                    <!--                                                <div class="textch">  <span>    <?php echo $truncated = (strlen($name) > 15) ? substr($name, 0, 15) . '...' : $name; ?> </span>   </div>   -->
                                            ...
                                            <?php if ($i == 1) { ?>
                                                <div class="textch">  <span>    <?php echo $truncated = (strlen($name) > 15) ? substr($name, 0, 15) . '...' : $name; ?> </span>   </div>
                                            <?php } else { ?>
                                                <div class="textch">  <span> <i class="fa <?php
                                                        if ($ext == 'docx' || $ext == 'doc') {
                                                            echo 'fa-file-word-o';
                                                        } else if ($ext == 'pdf') {
                                                            echo 'fa-file-pdf-o';
                                                        }
                                                        ?> fa-fw" style=""></i>   <?php echo $truncated = (strlen($name) > 15) ? substr($name, 0, 15) . '...' : $name; ?> </span>   </div>
                                                                            <?php } ?>
                                        </div> 
                                    </div>
                        ...
                        foreach ($dirArray as $name => $fileInfo):
                            ...
                            if ($ext == '') {
                                ...
                                if (strlen($pos) != 0) {
                                    ...
                                    ?>
                                    <div class="col-lg-3" >
<!--                                        <div class="panel panel-primary text-center task " oncontextmenu="myStyle('<?php echo urldecode(ltrim($fileInfo['url_path'], "?dir=")); ?>',<?php echo $i; ?>, '<?php echo $name; ?>');" id="bgstyle<?php echo $i; ?>" style="padding:10px;border: 0px solid #5bc0de !important;margin: 0px 10px 0px;margin-bottom:20px;webkit-box-shadow: 0 1px 1px 0 rgba(0,0,0,.2);
                                             box-shadow: 0 1px 1px 0 rgba(0,0,0,.2);" onClick="myStyle('<?php echo urldecode(ltrim($fileInfo['url_path'], "?dir=")); ?>',<?php echo $i; ?>, '<?php echo $name; ?>');">-->
                                        <div class="panel panel-primary text-center golink<?php echo $i; ?>"  id="bgstyle<?php echo $i; ?>" style="padding:10px;border: 0px solid #5bc0de !important;margin: 0px 10px 0px;margin-bottom:20px;webkit-box-shadow: 0 1px 1px 0 rgba(0,0,0,.2);
                                             box-shadow: 0 1px 1px 0 rgba(0,0,0,.2);" onClick="myStyle('<?php echo urldecode(ltrim($fileInfo['url_path'], "?dir=")); ?>',<?php echo $i; ?>, '<?php echo $name; ?>');">
                                            <!--<a href="<?php echo $fileInfo['url_path']; ?>"   class="clearfix tooltip1"  style='opacity:1;color: #161616;' title="<?php echo $name; ?>" data-name="<?php echo $name; ?>" >-->
                                                <?php if ($i == 1) { ?>
                                <!--                                                <span  onclick="back()" clas="textch">
...
var dirpah="<?php echo $_SERVER['REQUEST_URI']; ?>/"+rename;
            //doubleclick
            jQuery(function ($) {
                $('.golink' + val).click(function () {
                    return false;
                }).dblclick(function () {
                    window.location .href = dirpah;
                    return false;
                });
            });
        ...
        function previewreq() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#getPreview').html('<iframe src="https://docs.google.com/viewerng/viewer?url=https://www.employeemasterdatabase.com/' + data + '&embedded=true" width="100%" height="100%" scrolling="no" style="overflow:hidden; margin-top:-4px; margin-left:-4px; border:none;"></iframe>');
...
//                    }, 900);
    ...
    <style>
          .back-blue {background-color: rgb(48, 176, 251);color: #fff; }
    </style>
    <script>
...
<nav id="context-menu" class="context-menu">
    <ul class="context-menu__items">
      ...
      <li class="context-menu__item">
        <a href="#" class="context-menu__link" data-action="Edit" data-display="renameFolder"><i class="fa fa-edit"></i> Edit Task</a>
      </li>
      <li class="context-menu__item">
        <a href="#" class="context-menu__link" data-action="Delete" data-display="delFolder"><i class="fa fa-times"></i> Delete Task</a>
      </li>
    </ul>

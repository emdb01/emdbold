                ...
                if ($_POST['filepath'] != '') {
                    ...
                    <div class="row" style="    margin-top: 100px;">
                        ...
                        foreach ($dirArray as $name => $fileInfo):
                            ...
                            //echo trim($fileInfo['url_path'],"?dir=");
                            ?>
    ...
    top: 200px;">
                        ...
                        foreach ($dirArray as $name => $fileInfo):
                            ...
                            if ($ext != '') {
                                ...
                                <div class="col-lg-3"  >
                                    <div id="bgstyle<?php echo $i; ?>" class="panel panel-primary text-center no-boder "  style="padding:2px;margin:10px" onClick="myStyle('<?php echo urldecode($fileInfo['url_path']); ?>',<?php echo $i; ?>, '<?php echo $name; ?>');">
